...
app.controller('MainCtrl', ['$scope', '$ionicSideMenuDelegate', '$ionicHistory', '$cordovaFacebook', 'authService', 'userService',
    function($scope, $ionicSideMenuDelegate, $ionicHistory, $cordovaFacebook, authService, userService) {
